...
//		printf("------ra = %.3f|| \n", ra);
	...
	mlx_put_image_to_window(d->mlx, d->win, d->wall.no.img, 64, 64);
	mlx_put_image_to_window(d->mlx, d->win, d->wall.so.img, 200, 200);
	mlx_put_image_to_window(d->mlx, d->win, d->wall.ea.img, 300, 300);
	mlx_put_image_to_window(d->mlx, d->win, d->wall.we.img, 400, 400);
